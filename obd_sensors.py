...
SENSORS = [
    ...
    Sensor("temp"                  , "F\nCoolant Temp"				, "0105" , temp             ,"F"      ),
    Sensor("short_term_fuel_trim_1", "%\nS-T Fuel Trim"				, "0106" , fuel_trim_percent,"%"      ),
    Sensor("long_term_fuel_trim_1" , "%\nL-T Fuel Trim"				, "0107" , fuel_trim_percent,"%"      ),
    Sensor("short_term_fuel_trim_2", "%\nS-T Fuel Trim"				, "0108" , fuel_trim_percent,"%"      ),
    Sensor("long_term_fuel_trim_2" , "%\nL-T Fuel Trim"				, "0109" , fuel_trim_percent,"%"      ),
    Sensor("fuel_pressure"         , "FuelRail Pressure"			, "010A" , cpass            ,""       ),
    Sensor("manifold_pressure"     , "psi\nIntk Manifold"			, "010B" , intake_m_pres    ,"psi"    ),
    Sensor("rpm"                   , "Engine RPM"					, "010C1", rpm              ,""       ),
    Sensor("speed"                 , "MPH\nVehicle Speed"			, "010D1", speed            ,"MPH"    ),
    Sensor("timing_advance"        , "degrees\nTiming Advance"		, "010E" , timing_advance   ,"degrees"),
    Sensor("intake_air_temp"       , "F\nIntake Air Temp"			, "010F" , temp             ,"F"      ),
    Sensor("maf"                   , "lb/min\nAirFlow Rate(MAF)"	, "0110" , maf              ,"lb/min" ),
    ...
    Sensor("o211"                  , "%\nO2 Sensor: 1 - 1"			, "0114" , fuel_trim_percent,"%"      ),
    Sensor("o212"                  , "%\nO2 Sensor: 1 - 2"			, "0115" , fuel_trim_percent,"%"      ),
    Sensor("o213"                  , "%\nO2 Sensor: 1 - 3"			, "0116" , fuel_trim_percent,"%"      ),
    Sensor("o214"                  , "%\nO2 Sensor: 1 - 4"			, "0117" , fuel_trim_percent,"%"      ),
    Sensor("o221"                  , "%\nO2 Sensor: 2 - 1"			, "0118" , fuel_trim_percent,"%"      ),
    Sensor("o222"                  , "%\nO2 Sensor: 2 - 2"			, "0119" , fuel_trim_percent,"%"      ),
    Sensor("o223"                  , "%\nO2 Sensor: 2 - 3"			, "011A" , fuel_trim_percent,"%"      ),
    Sensor("o224"                  , "%\nO2 Sensor: 2 - 4"			, "011B" , fuel_trim_percent,"%"      ),
